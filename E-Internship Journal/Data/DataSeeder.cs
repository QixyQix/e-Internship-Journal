    ...
    public static class DataSeeder
    {
        public static async void SeedData(ApplicationDbContext db)
        {
            ...
            var batchObject = new Batch[]
            {
                ...
                new Batch { BatchName = "AY1718S2", Description = "Academic Year 2017-2018 Semester 2", StartDate = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), EndDate = DateTime.ParseExact("26/02/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Course = courseObject[0] },
