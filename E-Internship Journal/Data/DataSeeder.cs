...
namespace E_Internship_Journal.Data
{
    public static class DataSeeder
    {
        public static async void SeedData(ApplicationDbContext db)
        {
            ...
            {
                new Batch { BatchName = "AY1718S1"+ courseObject[0].CourseCode, Description = "Academic Year 2017-2018 Semester 1", StartDate = DateTime.ParseExact("14/06/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), EndDate = DateTime.ParseExact("15/09/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Course = courseObject[0] },
                new Batch { BatchName = "AY1718S2"+ courseObject[0].CourseCode, Description = "Academic Year 2017-2018 Semester 2", StartDate = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), EndDate = DateTime.ParseExact("26/02/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Course = courseObject[0] },
                new Batch { BatchName = "AY1718S1"+ courseObject[1].CourseCode, Description = "Academic Year 2017-2018 Semester 1", StartDate = DateTime.ParseExact("14/06/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), EndDate = DateTime.ParseExact("15/09/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Course = courseObject[1] },
                new Batch { BatchName = "AY1718S2"+ courseObject[1].CourseCode, Description = "Academic Year 2017-2018 Semester 2", StartDate = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), EndDate = DateTime.ParseExact("28/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Course = courseObject[1] },
                new Batch { BatchName = "AY1718S1"+ courseObject[2].CourseCode, Description = "Academic Year 2017-2018 Semester 1", StartDate = DateTime.ParseExact("14/02/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), EndDate = DateTime.ParseExact("15/08/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Course = courseObject[2] },
            ...
            var dayObject = new Day_Record[] {                //student1
                ...
                new Day_Record { Month = monthObject[1], Date = DateTime.ParseExact("18/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 7, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("26/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("02/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("04/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },

                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },

                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },

                new Day_Record { Month = monthObject[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 13, IsPresent = true },
                new Day_Record { Month = monthObject[3], Date = DateTime.ParseExact("23/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 13, IsPresent = true },
                new Day_Record { Month = monthObject[3], Date = DateTime.ParseExact("24/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 13, IsPresent = true },
            ...
            var taskObject = new Task_Record[] {
                ...
                //week1
                 ...
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("26/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Auto approve student account if using ichat email. (As requested from Mr Low)", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("26/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on generating xml testcase", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create Views for generating xml testcase", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add and remove testcase inputs in view", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set up basic controller functionality", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on opening link as tab for lecturer to copy and paste xml", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Might change from post to controller function to javascript function to generate xml", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Complete View for generating xml testcase", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Complete View for xml testcase results", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test controller logic to send over/handle inputs send over from form to controller", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Issue hit, each testcase should be able to accept multiple inputs.Need to revamp feature.", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit view allowing multiple input", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Error hit, after adding another row, add input logic not working because of dom navigation logic, which the default typed in code has extra text child nodes.", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bug Fix error tbc, already tried cleaning dom element before navigating, so far not working.", WeekNo = 9 },
                 ...
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("02/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit database schema, to enable locking of student registration.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("02/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Prevent students from selecting classes which are locked when registering for an account.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix errors on class locking controls.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Feature where lecturer can add a new class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test/Fix Class Name input in add new class (try putting in symbol values)", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("04/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix/Touch up class name validation", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("04/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Testing class name in add class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add semester and acad year options (dropdown list select) for adding new class.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Lec_Class association when lecturer create new class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add acad year display to all views with class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add acad year controls to update class controls", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Error with loop logic displaying classes in Manage Assignments, AcadID displaying on another class instead of its own.", WeekNo = 10 },

                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add acad year display to all views with class and edit all controller methods for to display the views ", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Above task completed for Lecturer’s controls, Admin not entirely completed yet.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Application testing.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix prod site student error after trying to confirm email. Debug and check if error was logged.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Karl Kwan (refer to Meeting 8)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create classes and assign to lecturers as per Mr Kwan’s email request.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Push new code to live site. (Up till allow lecturer to create a new class)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Lock all classes except Mr Kwan’s 8 new classes.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit controller to only display associated classes for each lecturer in Lock Class Registration page instead of displaying all classes.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit controller to display all students in classes in the module if the lecturer is a module coordinator, for approve/suspend student pages.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix code logic of if, module coordinator, display all students in classes associated to that module", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add missing links from admin’s manage students (same ones that are in ManageClassesAndStudents in lecturer controls)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Push new code up to live site, has important updates needed before live use.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debugging for Karl Kwan’s reported errors.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create new account for Karl Kwan, his is supposedly corrupted.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debugging for Karl Kwan’s reported errors cont.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Application testing with IE (Karl Kwan used Internet Explorer on his Windows machine)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Check if any errors were logged in the server.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Had talk with Mr Low, update on progress thus far and what has been going on. Mr Low, mentioned about new feature to allow deletion of older accounts and data to clear space/free up the application.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Check on error log given by Karl Kwan.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix prod site errors. Updated/Added old solutions, testcases & submissions.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Issues regarding Mr Hubertus and Ms Junie Tan’s access to accounts (Forgot password wasn’t working for them & Emails used were invalid)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug issues regarding Mr Shek’s student being unable to submit his assignment (AssignmentTitle: Listquestion in class NVWPG2) (Generic error display) (Error tested on offline ver., Infinite loop error)", WeekNo = 11 },
                 ...
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test Mr Karl Kwan’s assignment using student’s solution to check error (Test locally and on prod site server for error message) (Answer ends after one wrong input, student’s continues which creates an infinite loop)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix error of students still being unable to create accounts (adminno already exists) (Solution: delete accounts in AspNetUsers)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix error of auto approve student accounts using ichat email.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Identified that on prod site student programs which causes infinite loops will throw error and not complete the submission successfully. (Mr Kwan/Mr Shek ‘s student’s error)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Handle issue for some of the users.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix prod site errors. Updated/Added old solutions, testcases & submissions.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Tested some assignments on prod site to see if working or not. Tested oldest assignment on prod site to check if grading was working again. (Success, not all tested)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix student admin issues using SPade", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug infinite loop error", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set up another website on server to test the infinite loop error.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Figure out/set up proper maintenance mode for prod server. Allowing only server admin to access website and disable access to the public. (Added IPAddress and domain restrictions with custom error page)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix student admin issues", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Setup another website on server to test the infinite loop error cont.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Secondary Test server still throwing errors, cannot log in to accounts. Still cannot use to test errors.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug infinite loop error. Still unable to fix.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add notice to post submission page, if student gets 0 display notice to check if output/error messages are the same and no infinite loop etc.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Solve admin issues sent in by students/lecturers", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Adjust incorrect notification", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug infinite loop error (on local if try to view page without running will throw same error as on the server)", WeekNo = 12 },
                
                 new Task_Record { MonthRecord = monthObject[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Solve admin issues sent in by lecturers/students", WeekNo = 13 },
                 new Task_Record { MonthRecord = monthObject[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Successfully Deploy on live.", WeekNo = 13 },
                 new Task_Record { MonthRecord = monthObject[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Monitor web server.", WeekNo = 13 },
            ...
            //student2
            var monthObject2 = new Month_Record[] {
                new Month_Record { InternshipRecordId = internshipObject[1].InternshipRecordId, SoftSkillsCompetencyDoneWell = "I did well in my time management manage to finish up all the task give to me on time and i did my task very carefully, did a few time of checking and troubleshoot before hand in my task to my supervisor.", SoftSkillsCompetencyImprove = "I feel that i should improve in my communication skills with my colleague so i can interact and get to know more about them, also that i will not feel awkward when having meeting and can give out opinion.", TechnicalCompetencyApplied = "i have applied things that i had learn in the school. Got to apply some simple knowledge on Design experience when creating the website do a simple survey question and post it online to let the public answer.", TechnicalCompetencyDoneWell = "I did well on how quickly i can think of an idea and suggest out by giving some idea and get accepted. As also because i have the idea i gave is something similar to what i have did in one of my assignment in school", TechnicalCompetencyImprove="I want to improve on how i can be more confident because i did hesitate not to give my idea as i thought it was bad, was very happy that got accepted." },
                ...
                new Month_Record { InternshipRecordId = internshipObject[1].InternshipRecordId, SoftSkillsCompetencyDoneWell = "Given the fact that i am a cautious person, i would always check to double confirm, I often give my opinion on solution to help solving an issue", SoftSkillsCompetencyImprove = "I would need to improve on by over confidence attitude, whenever i see my colleague talking, i often give my own opinion without being asked for, i can be rather rude in such ways.", TechnicalCompetencyApplied = "i have applied things i learn school. Got to apply some basic skills on programming experience when hosting a website i am able to follow up with the project.", TechnicalCompetencyDoneWell = "i manage to excel when it comes to quick thinking and creativity. i can think of an idea and suggest out by giving some idea and get accepted. As also because i have the idea i gave is something similar to what i have did in one of my assignment in school", TechnicalCompetencyImprove="I want to learn more so that I am able to improve my programming skills and with it I can help others whenever they encounter a problem." },
                new Month_Record { InternshipRecordId = internshipObject[1].InternshipRecordId, SoftSkillsCompetencyDoneWell = "Fixing new known bugs after deployment to production environment", SoftSkillsCompetencyImprove = "Would need to improve on my troubleshooting skills so to understand the problem easily", TechnicalCompetencyApplied = "i have applied things i learn school. Got to apply some basic skills on programming experience when hosting a website i am able to follow up with the project.", TechnicalCompetencyDoneWell = "i manage to excel when it comes to quick thinking and creativity. i can think of an idea and suggest out by giving some idea and get accepted. As also because i have the idea i gave is something similar to what i have did in one of my assignment in school", TechnicalCompetencyImprove="I want to learn more so that I am able to improve my programming skills and with it I can help others whenever they encounter a problem." },
            };
            foreach (Month_Record mr in monthObject2)
            {
                db.Month_Records.Add(mr);
            }
            db.SaveChanges();

            var dayObject2 = new Day_Record[] {

                //student2
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 1, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("31/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 1, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("01/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 1, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("02/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 1, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("03/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 1, IsPresent = true },

                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("06/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 2, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("07/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 2, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("08/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 2, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("09/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 2, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("10/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 2, IsPresent = true },

                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 3, IsPresent = true },
                //sick mc 2 days 14 - 15/11/2017
                //new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("14/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 3, IsPresent = true },
                //new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("15/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 3, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("16/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 3, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("17/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 3, IsPresent = true },

                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 4, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("21/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 4, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("22/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 4, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("23/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 4, IsPresent = true },
                new Day_Record { Month = monthObject2[0], Date = DateTime.ParseExact("24/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 4, IsPresent = true },

                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 5, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("28/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 5, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("29/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 5, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("30/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 5, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("01/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 5, IsPresent = true },

                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 6, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("05/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 6, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("06/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 6, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("07/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 6, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("08/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 6, IsPresent = true },

                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 7, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("12/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 7, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("13/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 7, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("14/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 7, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("15/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 7, IsPresent = true },

                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("19/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 8, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("20/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 8, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("21/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 8, IsPresent = true },
                new Day_Record { Month = monthObject2[1], Date = DateTime.ParseExact("22/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 8, IsPresent = true },

                //new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("25/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 8, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("26/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 9, IsPresent = true },

                //new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("01/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 8, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("02/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("04/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },

                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },

                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
                new Day_Record { Month = monthObject2[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },

                new Day_Record { Month = monthObject2[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 13, IsPresent = true },
                new Day_Record { Month = monthObject2[3], Date = DateTime.ParseExact("23/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 13, IsPresent = true },
                new Day_Record { Month = monthObject2[3], Date = DateTime.ParseExact("24/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 13, IsPresent = true },
                };
            foreach (Day_Record dr in dayObject2)
            {
                db.Day_Records.Add(dr);
            }
            db.SaveChanges();
            ...
            var taskObject2 = new Task_Record[] {
                //student 2
                //week1
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Learn about the roles to play", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Explore application, download and try to run source code", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Met with previous project manager to handover for source code setup and partial explanation (Error with setup/code for adding java/python assignment)", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("30/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on Hangfire documentation about background processing", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("31/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Setup and try running code with visual studio 2015", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("31/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on Hangfire documentation about background processing cont.", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("31/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Further read up on Hangfire documentation about background methods", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("31/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Understanding on terms about setup/code error (add java/python assignment)", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("31/10/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Search up on error/Talk to Mr Low about said error. ", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("01/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Setup spare computer for testing", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("01/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on usage of Processes", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("01/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Figure out error (Error adding java/python assignment) (Solved) (Cause: VS Solution not in the same hard drive partition)", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("01/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Discussion with colleagues about code (Code Briefing)", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("01/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bug Fix Hangfire (Try different versions Hangfire / Strong Key Signing, use package) ", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("02/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Explore and test code and web application for further understanding", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("02/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bug: During login if admin no letter (e.g. p/s/a) entered is in caps error will be thrown to user.", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("02/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bug Fixed Hangfire Dashboard Click into Jobs etc (Cause: Hangfire Database error) (Cause: Hangfire Database error) ", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("03/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Figure out errors; Not being able to add python or java due to python not being able to find the upload file in the file path (on local)", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("03/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Low and Mr Karl Kwan, about changes to be made: Allow lecturer to be able to view assignment as if he was a student and allow Admin/Lecturer to approve a new registration.", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("03/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Prepare for demo; add students to actual database for Mr Karl Kwan for his lesson starting week 1 of the next term. Contact him if no response from him before dateline.", WeekNo = 1 },

                 //week2
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("06/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "add students to actual database for Mr Karl Kwan for his lesson starting week 1 of the next term. Contact him if no response from him before dateline.", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("06/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Begin adding lecturer’s student view. (added controller, views, viewmodels etc. code)", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("07/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add “ghost” student account creation on login as lecturer.", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("07/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Research and test to see which way of coding the feature is better. ", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("07/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create a “ghost/temp” student account for the lecturer to view it", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("08/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Implement test assignment feature.", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("08/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "'System.InvalidOperationException' in System.dll ('Cannot process request because the process (20496) has exited.') System.InvalidOperationException", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("09/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Allow Lecturer to Test Assignment despite assignment being unavailable date wise.", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("09/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Despite max attempt still allow Lecturer to Test Assignment", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("09/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Possible Feature  – Delete submission.", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("09/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Feature where student accounts must be approved before logging in", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("10/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add View & Functionality for admins and lecturers to approve or reject student accounts.", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("10/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Select all checkbox", WeekNo = 2 },

                 //week3
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Nav Bar link for admins and lecturers", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Alertify.js package and use it for user button click feedback", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set Students created by lecturers/admins to be already approved", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix number of accounts rejected counter", WeekNo = 3 },
                 //mc
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("16/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Modify grade, sandbox, lecturer controller and student controller", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("16/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Study and test grade and sandbox classes and methods", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("17/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Hit code structure problem, grade and sandbox classes currently only return a decimal, need to think of a way to pass over the value of if regex check", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("17/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Tried using Session storage but HttpContext.Current.Session not defined/does not exist.", WeekNo = 3 },

                 //week4
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Implement Regex Check Feature; Fix Regex match method expressions", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Tried using Static Variable in Grade then retrieve in Student Controller, but value changes to false for some reason after a certain method section.", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Error Hit: Static regexCheck variable in grade class check to false before the check to save the entry into the database.", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("21/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Change return values for sandbox and grade to make Regex Check possible.", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("21/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Change all Boolean variables regexResult to Nullable Booleans", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("21/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Regex Check result into Student Post Submission View", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("21/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Modify Database schema for regex, store regex expressions in a separate regex table instead of storing in assignments.", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("22/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix errors brought up by database change.", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("22/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix ambiguous call between System Regex object and DB Modal Regex DB object", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("22/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Errors of being unable to save assignment & fix sandbox return value methodology", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("22/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add description column to regular expression database table", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("23/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bind Add assignment Drop down list to database table data", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("23/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Error Hit: cannot add java (Process.Start, cannot find file specified) and C# assignments.", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("23/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Regex Check throwing error, may be due to java path", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("23/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bind Add assignment Drop down list to database table data", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject2[0], Date = DateTime.ParseExact("24/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bug Fix for adding java and C# assignments, null return object for solution and regexCheck method throwing error", WeekNo = 4 },

                 //week5
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "C# assignment error grading (cause: file path given to regexcheck method in grading has “-cp” infront) (solution: add another regex check to trim file path string)", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Karl Kwan to discuss about features/implementation and issues.", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Java assignment grading error to be continued, check ErrorLog/ErrorNotes", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("28/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Java assignment grading error (cause: filepath passed to regexcheck method was not in a proper file path format) (solution: use regex and string replace methods to build a proper path)", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("28/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Find back code version without regex check feature, to be published on the production site.", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("28/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Find back old databases schema before regex check feature.", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("28/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on how to do database migration/update production schema.", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("29/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Figure out error caused by submission, Assignment Test Case must have a Description if not will throw error.", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("29/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on database versioning", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("30/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Move approve student link into Manage Class / Student in Lecturer Console.", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("30/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "And Move approve student link into Manage Student in Admin Console", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("30/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Code Testing for errors submitting assignments as Lecturer", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("01/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Approve Student sort by class function ", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("01/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Restructure controller classes", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("01/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Approve Student checkbox onclick still not working/being triggered.", WeekNo = 5 },

                 //week6
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Approve Student Checkbox onclick", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add send Reject Email upon student registration rejection.", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Approve Student checkbox onclick still not working/being triggered.", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("05/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Back to Lecturer’s Management View to layout view so link persists for temp student", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("05/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add ‘use lowercase’ reminder to AdminNo in Student Registration", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("05/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add ‘Add Lecturer test submission always show 1.", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("05/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Reformat reject email code logic and message.", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("06/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Low: Progress Update (Refer to Meeting 4)", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("06/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Error with consolidating database schema and code schema", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("06/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix code side Database mapping issues", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("07/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Class Score Excel Generation: Create Controller function to generate excel document and Figure out how to trigger download excel from controller side", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("08/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Class Score Excel Generation: Redo Excel creation code logic", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("08/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Implement/Add EPPlus to generate advanced formatting excel documents", WeekNo = 6 },

                 //week7
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Refine/Fix Class Score Excel Generation code logic & excel formatting.", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Complete Class Score Excel Generation.", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set up Assignment on Production for Mr Low class (Practical 2)", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("12/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit database schema for suspending student", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("12/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Account controller code to check if student is suspended", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("12/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create view for suspended student account", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("12/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Explore use of DB version control and LiquiBase", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("13/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create Suspend student controls for lecturer", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("13/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit reject student email message telling student to recreate account ", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("14/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Remove Student Contact No. (Comment out/set default value 0)", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("14/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Approve Student load for admin console", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("14/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Suspend Student load for admin console", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("14/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Low – progress update (refer to Meeting 5 in onenote)", WeekNo = 7 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("15/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Code/Application Testing: Test submission file formats", WeekNo = 7 },

                 //week8
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("18/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Public Holiday Deepavali", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("19/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Code/Application Testing", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("19/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on web deploy onto IIS and updating of database.", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("19/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Possible Issue: Realise submitted solutions, testcases and student submissions are saved locally so need to copy over files from live site and port over to edited code solution.", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("20/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Backup live site database and code", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("20/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Merge and prep edited code solution for deploy", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("20/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test making changes and bringing over solutions/testcases/submissions locally", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("20/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Hit Error running script generated from live server SQL DB. Unable to create db.", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("21/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Final Testing of code and backup of code and databases", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("21/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Deployment of code onto live site (SPadeServerV3)", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("21/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Deployment successful but hit error with some functions and permissions", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("21/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Added database user and permission access to new IIS site", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("21/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Karl Kwan about uploading of solution files from dos to unix and unix to dos. (Deployed code was still not fully working then)", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("22/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Karl Kwan (refer to meeting 6)", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("22/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix errors thrown by deployed code for permissions and functions", WeekNo = 8 },
                 new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("22/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Continue testing deployed code", WeekNo = 8 },

                 //week9
                 //new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("25/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Approve all student accounts in prod db (by default was set to 0 when created new approved column)", WeekNo = 9 },
                 //new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("25/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test deployed code functions", WeekNo = 9 },
                 //new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("25/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test Create assignment solution and testcase from Mr Karl Kwan. (Test if can receive file with linux line ending)", WeekNo = 9 },
                 //new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("25/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on creation of XML for testcase generation", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("25/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Public Holiday Christmas", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("26/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Auto approve student account if using ichat email. (As requested from Mr Low)", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("26/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on generating xml testcase", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create Views for generating xml testcase", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add and remove testcase inputs in view", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set up basic controller functionality", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Read up on opening link as tab for lecturer to copy and paste xml", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("27/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Might change from post to controller function to javascript function to generate xml", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Complete View for generating xml testcase", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Complete View for xml testcase results", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("28/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test controller logic to send over/handle inputs send over from form to controller", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Issue hit, each testcase should be able to accept multiple inputs.Need to revamp feature.", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit view allowing multiple input", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Error hit, after adding another row, add input logic not working because of dom navigation logic, which the default typed in code has extra text child nodes.", WeekNo = 9 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("29/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Bug Fix error tbc, already tried cleaning dom element before navigating, so far not working.", WeekNo = 9 },

                 //week10
                 //new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("01/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Cont. Figure out work around for additional blank text child nodes in DOM causing adding new inputs to go to wrong table cell.", WeekNo = 10 },
                 //new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("01/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Archive and revert code, to prep to continue with other features.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("02/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit database schema, to enable locking of student registration.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("02/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Prevent students from selecting classes which are locked when registering for an account.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix errors on class locking controls.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Feature where lecturer can add a new class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("03/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test/Fix Class Name input in add new class (try putting in symbol values)", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("04/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix/Touch up class name validation", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("04/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Testing class name in add class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add semester and acad year options (dropdown list select) for adding new class.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Lec_Class association when lecturer create new class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add acad year display to all views with class", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add acad year controls to update class controls", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("05/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Error with loop logic displaying classes in Manage Assignments, AcadID displaying on another class instead of its own.", WeekNo = 10 },

                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add acad year display to all views with class and edit all controller methods for to display the views ", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Above task completed for Lecturer’s controls, Admin not entirely completed yet.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Application testing.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix prod site student error after trying to confirm email. Debug and check if error was logged.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Karl Kwan (refer to Meeting 8)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create classes and assign to lecturers as per Mr Kwan’s email request.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Push new code to live site. (Up till allow lecturer to create a new class)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Lock all classes except Mr Kwan’s 8 new classes.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit controller to only display associated classes for each lecturer in Lock Class Registration page instead of displaying all classes.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("09/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Edit controller to display all students in classes in the module if the lecturer is a module coordinator, for approve/suspend student pages.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix code logic of if, module coordinator, display all students in classes associated to that module", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add missing links from admin’s manage students (same ones that are in ManageClassesAndStudents in lecturer controls)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Push new code up to live site, has important updates needed before live use.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debugging for Karl Kwan’s reported errors.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("10/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Create new account for Karl Kwan, his is supposedly corrupted.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debugging for Karl Kwan’s reported errors cont.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Application testing with IE (Karl Kwan used Internet Explorer on his Windows machine)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Check if any errors were logged in the server.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Had talk with Mr Low, update on progress thus far and what has been going on. Mr Low, mentioned about new feature to allow deletion of older accounts and data to clear space/free up the application.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("11/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Check on error log given by Karl Kwan.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix prod site errors. Updated/Added old solutions, testcases & submissions.", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Issues regarding Mr Hubertus and Ms Junie Tan’s access to accounts (Forgot password wasn’t working for them & Emails used were invalid)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug issues regarding Mr Shek’s student being unable to submit his assignment (AssignmentTitle: Listquestion in class NVWPG2) (Generic error display) (Error tested on offline ver., Infinite loop error)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug issues of Mr Kwan’s student being unable to submit his assignment (LeftPointingHalfTrigangle) (Generic error display – check in server for message) (Might be same as above error) (Get Submission from student)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("12/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix errors of students being unable to sign up. (Cause: Student accounts were previously created for testing prob using bulk creation with emails no longer valid) (Solution: Backup & Delete all old DISM submissions & accounts under 1a01-03 & 1b21-22)", WeekNo = 11 },

                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test Mr Karl Kwan’s assignment using student’s solution to check error (Test locally and on prod site server for error message) (Answer ends after one wrong input, student’s continues which creates an infinite loop)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix error of students still being unable to create accounts (adminno already exists) (Solution: delete accounts in AspNetUsers)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix error of auto approve student accounts using ichat email.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Identified that on prod site student programs which causes infinite loops will throw error and not complete the submission successfully. (Mr Kwan/Mr Shek ‘s student’s error)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Handle issue for some of the users.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix prod site errors. Updated/Added old solutions, testcases & submissions.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Tested some assignments on prod site to see if working or not. Tested oldest assignment on prod site to check if grading was working again. (Success, not all tested)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix student admin issues using SPade", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug infinite loop error", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("16/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set up another website on server to test the infinite loop error.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Figure out/set up proper maintenance mode for prod server. Allowing only server admin to access website and disable access to the public. (Added IPAddress and domain restrictions with custom error page)", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix student admin issues", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("17/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Setup another website on server to test the infinite loop error cont.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Secondary Test server still throwing errors, cannot log in to accounts. Still cannot use to test errors.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug infinite loop error. Still unable to fix.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("18/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add notice to post submission page, if student gets 0 display notice to check if output/error messages are the same and no infinite loop etc.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Solve admin issues sent in by students/lecturers", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Adjust incorrect notification", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject2[2], Date = DateTime.ParseExact("19/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Debug infinite loop error (on local if try to view page without running will throw same error as on the server)", WeekNo = 12 },

                 new Task_Record { MonthRecord = monthObject2[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Solve admin issues sent in by lecturers/students", WeekNo = 13 },
                 new Task_Record { MonthRecord = monthObject2[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Successfully Deploy on live.", WeekNo = 13 },
                 new Task_Record { MonthRecord = monthObject2[3], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Monitor web server.", WeekNo = 13 },
                //Commented til here
            //     new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("23/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Help to resolve issue from the system", WeekNo = 13 },
            //     new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("23/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Minor tweak, help a student to retrieve his account", WeekNo = 13 },
            //     new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("23/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Continue monitoring web server", WeekNo = 13 },
            //     new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("24/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Continue monitoring web server", WeekNo = 13 },
            //     new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("24/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Write a documentation for reference in future.", WeekNo = 13 },
            //     new Task_Record { MonthRecord = monthObject2[1], Date = DateTime.ParseExact("24/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meet Mr Low for final assessment", WeekNo = 13 },
            };
            foreach (Task_Record tr in taskObject2)
            {
                db.Tasks.Add(tr);
            }
            db.SaveChanges();
