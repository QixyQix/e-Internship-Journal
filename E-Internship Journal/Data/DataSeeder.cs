    ...
    public static class DataSeeder
    {
        public static async void SeedData(ApplicationDbContext db)
        {
            ...
            var dayObject = new Day_Record[] {                //student1
                ...
                new Day_Record { Month = monthObject[0], Date = DateTime.ParseExact("06/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 1, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 2, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 3, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[0], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 4, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 5, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 6, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 10, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 11, IsPresent = true },
                ...
                new Day_Record { Month = monthObject[2], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), ArrivalTime = DateTime.Parse("9:00:00 AM"), DepartureTime = DateTime.Parse("6:00:00 PM"), WeekNo = 12, IsPresent = true },
            ...
            var taskObject = new Task_Record[] {
                ...
                //week1
                 ...
                 //week2
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("06/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "add students to actual database for Mr Karl Kwan for his lesson starting week 1 of the next term. Contact him if no response from him before dateline.", WeekNo = 1 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("06/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Begin adding lecturer’s student view. (added controller, views, viewmodels etc. code)", WeekNo = 1 },
                 ...
                 //week3
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Nav Bar link for admins and lecturers", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add Alertify.js package and use it for user button click feedback", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set Students created by lecturers/admins to be already approved", WeekNo = 2 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("13/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix number of accounts rejected counter", WeekNo = 2 },
                 ...
                 //week4
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Implement Regex Check Feature; Fix Regex match method expressions", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Tried using Static Variable in Grade then retrieve in Student Controller, but value changes to false for some reason after a certain method section.", WeekNo = 3 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("20/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Error Hit: Static regexCheck variable in grade class check to false before the check to save the entry into the database.", WeekNo = 3 },
                 ...
                 //week5
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "C# assignment error grading (cause: file path given to regexcheck method in grading has “-cp” infront) (solution: add another regex check to trim file path string)", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Meeting with Mr Karl Kwan to discuss about features/implementation and issues.", WeekNo = 4 },
                 new Task_Record { MonthRecord = monthObject[0], Date = DateTime.ParseExact("27/11/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Java assignment grading error to be continued, check ErrorLog/ErrorNotes", WeekNo = 4 },
                 ...
                 //week6
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix Approve Student Checkbox onclick", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add send Reject Email upon student registration rejection.", WeekNo = 5 },
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("04/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Approve Student checkbox onclick still not working/being triggered.", WeekNo = 5 },
                 ...
                 //week7
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Refine/Fix Class Score Excel Generation code logic & excel formatting.", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Complete Class Score Excel Generation.", WeekNo = 6 },
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("11/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Set up Assignment on Production for Mr Low class (Practical 2)", WeekNo = 6 },
                 ...
                 //wee8
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("18/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Public Holiday Deepavali", WeekNo = 7 },
                 ...
                 new Task_Record { MonthRecord = monthObject[1], Date = DateTime.ParseExact("25/12/2017", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Public Holiday Christmas", WeekNo = 8 },
                 ...
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Add acad year display to all views with class and edit all controller methods for to display the views ", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Above task completed for Lecturer’s controls, Admin not entirely completed yet.", WeekNo = 10 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("08/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Application testing.", WeekNo = 10 },
                 ...
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Test Mr Karl Kwan’s assignment using student’s solution to check error (Test locally and on prod site server for error message) (Answer ends after one wrong input, student’s continues which creates an infinite loop)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix error of students still being unable to create accounts (adminno already exists) (Solution: delete accounts in AspNetUsers)", WeekNo = 11 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("15/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Fix error of auto approve student accounts using ichat email.", WeekNo = 11 },
                 ...
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Solve admin issues sent in by lecturers/students", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Successfully Deploy on live.", WeekNo = 12 },
                 new Task_Record { MonthRecord = monthObject[2], Date = DateTime.ParseExact("22/01/2018", "dd/MM/yyyy", CultureInfo.InvariantCulture), Description = "Monitor web server.", WeekNo = 12 },
