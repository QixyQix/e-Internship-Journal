...
namespace E_Internship_Journal.API
{
    ...
    [Route("api/UserBatches1")]
    public class UserBatches1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public UserBatches1Controller(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/UserBatches1
        [HttpGet]
