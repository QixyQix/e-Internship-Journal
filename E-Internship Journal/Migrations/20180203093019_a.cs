...
namespace E_Internship_Journal.Migrations
{
    public partial class a : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ScheduleInternshipRecords",
                columns: table => new
                {
                    ScheduleIntershipRecordId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    LiaisonOfficerId = table.Column<string>(nullable: true),
                    ProjectId = table.Column<int>(nullable: false),
                    UserBatchId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_ScheduleIntershipRecordId", x => x.ScheduleIntershipRecordId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_CompetencyTitleId", x => x.CompetencyTitleId);
                    table.ForeignKey(
                        name: "FK_CompetencyTitles_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserBatchId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Allowance = table.Column<string>(type: "VARCHAR(15)", nullable: true),
                    BatchId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedBy = table.Column<string>(type: "VARCHAR(MAX)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Competencies_CompetencyTitles_CompetencyTitleId",
                        column: x => x.CompetencyTitleId,
                        principalTable: "CompetencyTitles",
                        principalColumn: "CompetencyTitleId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedbackCareer = table.Column<string>(type: "VARCHAR(100)", nullable: true, defaultValue: ""),
                    ...
                    FeedbackTakeaway = table.Column<string>(type: "VARCHAR(100)", nullable: true, defaultValue: ""),
                    FeedbackUseful = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    FinalGrading = table.Column<decimal>(type: "decimal", nullable: true),
                    JournalGrading = table.Column<int>(type: "int", nullable: true),
                    LiaisonOfficerId = table.Column<string>(nullable: false),
                    OverallGrading = table.Column<decimal>(type: "decimal", nullable: true),
                    OverallPerformance = table.Column<int>(type: "int", nullable: true),
                    PosterGrading = table.Column<int>(type: "int", nullable: true),
                    ...
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    SLOApproved = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    SLOOverallGrading = table.Column<decimal>(type: "decimal", nullable: true),
                    UserBatchId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoftSkillsCompetencyDoneWell = table.Column<string>(type: "VARCHAR(MAX)", nullable: true),
                    SoftSkillsCompetencyImprove = table.Column<string>(type: "VARCHAR(MAX)", nullable: true),
                    TechnicalCompetencyApplied = table.Column<string>(type: "VARCHAR(MAX)", nullable: true),
                    TechnicalCompetencyDoneWell = table.Column<string>(type: "VARCHAR(MAX)", nullable: true),
                    TechnicalCompetencyImprove = table.Column<string>(type: "VARCHAR(MAX)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternshipRecordId = table.Column<int>(type: "int", nullable: false),
                    TouchPointDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_TouchPointId", x => x.TouchPointId);
                    table.ForeignKey(
                        name: "FK_TouchPointRecords_Internship_Records_InternshipRecordId",
                        column: x => x.InternshipRecordId,
                        principalTable: "Internship_Records",
                        principalColumn: "InternshipRecordId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthRecordId = table.Column<int>(type: "int", nullable: false),
                    Remarks = table.Column<string>(type: "VARCHAR(MAX)", nullable: false, defaultValue: ""),
                    SupervisorRemarks = table.Column<string>(type: "VARCHAR(MAX)", nullable: false, defaultValue: ""),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Competencies_CompetencyTitleId",
                table: "Competencies",
                column: "CompetencyTitleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetencyTitles_CourseId",
                table: "CompetencyTitles",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "CompetencyTitle_TitleCompetency_UniqueConstraint",
                table: "CompetencyTitles",
                column: "TitleCompetency",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "Project_ProjectNameCompanyd_UniqueConstraint",
                table: "Projects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TouchPointRecords_InternshipRecordId",
                table: "TouchPointRecords",
                column: "InternshipRecordId");
